<!-- Edit Author Modal -->
<div id="editAuthorModal" class="hidden fixed inset-0 z-50 flex items-center justify-center">
    <!-- Backdrop -->
    <div class="absolute inset-0 bg-black/60 backdrop-blur-sm"
        onclick="document.getElementById('editAuthorModal').classList.add('hidden')"></div>

    <!-- Modal Content -->
    <div
        class="relative bg-[#1a1a2e] border border-white/10 rounded-2xl shadow-2xl w-full max-w-lg mx-4 p-6 animate-fade-in">
        <!-- Close Button -->
        <button onclick="document.getElementById('editAuthorModal').classList.add('hidden')"
        ...
        <!-- Header -->
        <h2 class="text-xl font-bold text-white mb-1">Edit Author</h2>
        <p class="text-gray-400 text-sm mb-6">Update author information below.</p>

        <!-- Form -->
        <form id="editAuthorForm" action="" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col gap-4">
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="edit_author_name"
                    ...
                    <div class="mb-4">
                        ...
                        <!-- Textarea -->
                        <textarea type="text" name="bio" id="edit_author_bio"
            ...
            <div class="flex items-center justify-end space-x-3 pt-2">
                <button type="button" onclick="document.getElementById('editAuthorModal').classList.add('hidden')"
